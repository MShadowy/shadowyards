...
public class MS_PStormProj2Director extends BaseEveryFrameCombatPlugin {
    
    private static final String PROJ_ID = "ms_voidtrail";
    private static final float SPARK_SPEED = 100f;
    private static final float MIN_SPARK_LIFETIME = 4f;
    private static final float MAX_SPARK_LIFETIME = 8f;
